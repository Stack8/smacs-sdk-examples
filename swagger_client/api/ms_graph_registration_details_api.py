...
class MSGraphRegistrationDetailsApi(object):
    ...
    def post_validation_ms_graph_app_registration_details(self, body, **kwargs):  # noqa: E501
        """Create the ms graph app registration details  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.post_validation_ms_graph_app_registration_details(body, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.post_validation_ms_graph_app_registration_details_with_http_info(body, **kwargs)  # noqa: E501
        else:
            (data) = self.post_validation_ms_graph_app_registration_details_with_http_info(body, **kwargs)  # noqa: E501
            return data

    def post_validation_ms_graph_app_registration_details_with_http_info(self, body, **kwargs):  # noqa: E501
        """Create the ms graph app registration details  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.post_validation_ms_graph_app_registration_details_with_http_info(body, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method post_validation_ms_graph_app_registration_details" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        if ('body' not in params or
                params['body'] is None):
            raise ValueError("Missing the required parameter `body` when calling `post_validation_ms_graph_app_registration_details`")  # noqa: E501
        ...
        return self.api_client.call_api(
            '/config/ms-graph/validation', 'POST',
            path_params,
            query_params,
            header_params,
            body=body_params,

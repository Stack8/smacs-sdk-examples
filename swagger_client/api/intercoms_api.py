...
class IntercomsApi(object):
    ...
    def post_intercom(self, body, server_id, **kwargs):  # noqa: E501
        """Create an intercom directory number  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.post_intercom(body, server_id, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param IntercomDirectoryNumberJson body: The details of the intercom directory number to create (required)
        :param int server_id: The id of the server where the intercom directory number is located (required)
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.post_intercom_with_http_info(body, server_id, **kwargs)  # noqa: E501
        else:
            (data) = self.post_intercom_with_http_info(body, server_id, **kwargs)  # noqa: E501
            return data

    def post_intercom_with_http_info(self, body, server_id, **kwargs):  # noqa: E501
        """Create an intercom directory number  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.post_intercom_with_http_info(body, server_id, async_req=True)
        >>> result = thread.get()
        ...
        if ('body' not in params or
                params['body'] is None):
            raise ValueError("Missing the required parameter `body` when calling `post_intercom`")  # noqa: E501
        # verify the required parameter 'server_id' is set
        if ('server_id' not in params or
                params['server_id'] is None):

...
class PhonesApi(object):
    ...
    def search_phone(self, **kwargs):  # noqa: E501
        """Search phones mobility by 'q', name, owner username, description, or extension.  # noqa: E501
        ...
        :param str name: Search phone mobility by matching name
        :param str owner_username: Search phone mobility by matching owner name
        :param str description: Search phone mobility by matching description
        :param str extension: Search phone mobility by matching extension
        :param int cucm_server_id: Search phone mobility by the id of the server they're located in

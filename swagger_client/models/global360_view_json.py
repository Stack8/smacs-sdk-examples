...
class Global360ViewJson(object):
    ...
    def __init__(self, primary_extensions=None, ipcc_extensions=None, translation_patterns=None, phones=None, extension_mobilities=None, snr_profiles=None, voicemails=None, uccx_agents=None, pcce_agents=None, end_users=None, ldap_user=None, sites=None):  # noqa: E501
